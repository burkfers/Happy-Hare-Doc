...
- **No v3-vs-v4 narrative in the reader-facing text of ANY page**, including
  ...
  page, rather than being lost), stripped the `Reference-Klipper-Events.md`
  table's
...
| `Reference-Klipper-Events.md` | Happy Hare `mmu:*` events | **done, hand-written but code-verified** — split from `Reference-Printer-Variables.md`; event parameters checked against every current event emission |
