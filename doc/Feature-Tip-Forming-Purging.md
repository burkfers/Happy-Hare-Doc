...
- **Purging**: Happy Hare's own standalone macro (`_MMU_PURGE`), an add-on
  purge system like [Blobifier](Feature-Addon-Integrations.md), or leave it
...
| Setting | Purpose |
|---|---|
| `Have Blobifier?` | See [Feature: Addon Integrations](Feature-Addon-Integrations.md) |
...
See [Feature: Addon Integrations](Feature-Addon-Integrations.md) for the
build/wiring side.
...
A dedicated purge system (like [Blobifier](Feature-Addon-Integrations.md))
...
- [Feature: Addon Integrations](Feature-Addon-Integrations.md) - Blobifier and the servo cutter build/wiring
