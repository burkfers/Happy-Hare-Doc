...
How this site itself gets built - `doc_tools/` at the repo root. Three jobs live here: generating screenshots of the menuconfig installer, generating the
...
[Code Layout](Dev-Code-Layout.md#command-discovery-and-registration) for how commands
...
- [Kconfig & Installer Architecture](Dev-Kconfig-Structure.md) - what `capture.py` is
  actually driving.
- [Code Layout](Dev-Code-Layout.md) - the command-discovery mechanism
